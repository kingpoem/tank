...
class GameLoop:
    ...
    def __initGame():
        ...
        # 初始化游戏屏幕
        from tank.game.defines import WINDOW_HEIGHT, WINDOW_TITLE, WINDOW_WIDTH
        ...
        pygame.display.set_icon(pygame.image.load("src/tank/assets/icon.png"))
    ...
    def run():
        ...
        preTicks = 0
        from tank.game.defines import BACKGROUND, FONT_COLOR, SMALL_FONT
        ...
        while GameLoop.isRunning:
            ...
            GameLoop.screen.blit(
                sceneUI, sceneUI.get_rect(center=GameLoop.screen.get_rect().center)
            )
